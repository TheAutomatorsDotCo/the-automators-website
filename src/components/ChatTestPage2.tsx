...
export function ChatTestPage2() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#0f0f1e]">
      <SEO
        title="Chat Widget Test 2"
        description="Internal test page for a second Chatwoot website widget."
        path="/chat-test-2"
        noindex
      />
      <StarsCanvas />
      <ChatwootWidget
        websiteToken={import.meta.env.VITE_CHATWOOT_WEBSITE_TOKEN_2}
        settings={SETTINGS}
      />
