            ...
            <div className="card-3d glass border border-white/10 rounded-xl sm:rounded-2xl overflow-hidden hover:border-white/20 transition-all">
              ...
              >
                <div className="flex-1">
                  ...
                  {openFAQ === 4 && (
                    <p className="text-white/70 mt-2 sm:mt-3 text-lg leading-relaxed">
                      Our AI Voice Agent solutions are custom-priced to your call volume, integrations, and goals—from a Starter tier for moderate volume to a fully custom Enterprise setup for high-volume operations. Book a free consultation and we'll put together a tailored quote. <Link to="/pricing" className="text-indigo-400 hover:text-indigo-300">Explore our plans</Link>.
                    </p>
                  )}
                </div>
                <ChevronDown
