          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={`relative inline-flex p-4 rounded-2xl bg-gradient-to-br ${service.gradient} text-white mb-6`}>
                  {service.icon}
                </div>
                <h3 className="relative text-white mb-3">
                  {service.title}
                  {(index === 0 || index === 1 || index === 2) && (
                    <span className="ml-2 text-xs text-indigo-400">→</span>
                  )}
                </h3>
                <p className="relative text-white/60 mb-6">{service.description}</p>
                ...
                {(index === 0 || index === 1 || index === 2) && (
                  <div className="relative mt-6 text-sm text-indigo-400 font-semibold">
                    Learn more →
                  </div>
                )}
              </Link>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {process.map((item, index) => (
              <div key={index} className="card-3d glass border border-white/10 rounded-3xl p-8 text-center hover:border-white/20 transition-all">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white mb-6">
                  {item.icon}
                </div>
                <div className="text-sm text-white/50 mb-2">Step {item.step}</div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="glass border border-white/10 rounded-3xl p-8 sm:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl gradient-text mb-6">Global Reach, Local Touch</h2>
                <p className="text-lg text-white/70 leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">Small Business Expertise</h4>
                    <p className="text-white/60">Built and turned around multiple small businesses</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-3 h-3 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 mt-2"></div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">Full-Service Support</h4>
                    <p className="text-white/60">Copywriting, e-commerce, and online marketing</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-3 h-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 mt-2"></div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">80/20 Strategy</h4>
                    <p className="text-white/60">Focus on high-impact areas that move the needle</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white mb-3">No Large Upfront Fees</h3>
            ...
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center text-white text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-3">Scales With Your Business</h3>
                  <p className="text-white/70 leading-relaxed">
            ...
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-3">No Contracts</h3>
                  <p className="text-white/70 leading-relaxed">
            ...
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-3">Value-Based Billing</h3>
                  <p className="text-white/70 leading-relaxed">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60">Real results from businesses we've helped automate.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="text-5xl gradient-text mb-4">15hrs</div>
              <h4 className="text-white mb-2">Saved Per Week</h4>
              <p className="text-white/60">Marketing agency automated client onboarding and reporting</p>
            </div>
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="text-5xl gradient-text mb-4">95%</div>
              <h4 className="text-white mb-2">Fewer Errors</h4>
              <p className="text-white/60">E-commerce business eliminated manual order processing</p>
            </div>
            <div className="card-3d glass border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all">
              <div className="text-5xl gradient-text mb-4">$50k</div>
              <h4 className="text-white mb-2">Annual Savings</h4>
              <p className="text-white/60">Consulting firm reduced admin overhead significantly</p>
            </div>
          </div>
        </div>
      </section>
