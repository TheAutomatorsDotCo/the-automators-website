...
export function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Automatically generate, process, and organize documents from invoices to contracts.',
      benefits: ['Instant generation', 'Automated filing', 'Easy retrieval'],
      gradient: 'from-rose-500 to-pink-500',
    },
    {
      icon: <BarChart3 className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: 'Reporting & Analytics',
      description: 'Get automated reports delivered to your inbox with actionable insights.',
      benefits: ['Scheduled reports', 'Custom dashboards', 'Actionable insights'],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#0f0f1e]">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none hidden sm:block">
        <div className="blob absolute top-20 left-1/4 w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 bg-indigo-500 rounded-full"></div>
        <div className="blob absolute bottom-40 right-1/4 w-56 h-56 sm:w-72 sm:h-72 lg:w-80 lg:h-80 bg-purple-500 rounded-full" style={{ animationDelay: '2s' }}></div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="relative text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">
                  {service.title}
                  {(index === 0 || index === 1 || index === 2) && (
                    <span className="ml-2 text-xs text-indigo-400">→</span>
                  )}
                </h3>
                <p className="relative text-white/60 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">{service.description}</p>
                <ul className="relative space-y-2 sm:space-y-3">
                  {service.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-start space-x-2 sm:space-x-3">
                      <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 mt-1.5 sm:mt-2"></div>
                      <span className="text-white/70 text-sm sm:text-base">{benefit}</span>
                    </li>
                  ))}
                </ul>
                {(index === 0 || index === 1 || index === 2) && (
                  <div className="relative mt-4 sm:mt-6 text-xs sm:text-sm text-indigo-400 font-semibold">
                    Learn more →
                  </div>
                )}
              </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
            {process.map((item, index) => (
              <div key={index} className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center hover:border-white/20 transition-all">
                ...
                <div className="text-xs sm:text-sm text-white/50 mb-2">Step {item.step}</div>
                <h3 className="text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">{item.title}</h3>
                <p className="text-white/60 text-sm sm:text-base leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>

          <div className="glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
              <div>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl gradient-text mb-4 sm:mb-6">Global Reach, Local Touch</h2>
                <p className="text-base sm:text-lg text-white/70 leading-relaxed mb-4 sm:mb-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="flex-shrink-0 w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 mt-1.5 sm:mt-2"></div>
                  <div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="flex-shrink-0 w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 mt-1.5 sm:mt-2"></div>
                  <div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="flex-shrink-0 w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 mt-1.5 sm:mt-2"></div>
                  <div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-lg sm:text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">No Large Upfront Fees</h3>
            ...
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center text-white text-lg sm:text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">Scales With Your Business</h3>
                  <p className="text-white/70 leading-relaxed text-sm sm:text-base">
            ...
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white text-lg sm:text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">No Contracts</h3>
                  <p className="text-white/70 leading-relaxed text-sm sm:text-base">
            ...
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white text-lg sm:text-xl font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  <h3 className="text-white mb-2 sm:mb-3 text-base sm:text-lg font-semibold">Value-Based Billing</h3>
                  <p className="text-white/70 leading-relaxed text-sm sm:text-base">
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl gradient-text mb-4 sm:mb-6 px-4">Success Stories</h2>
            <p className="text-base sm:text-lg lg:text-xl text-white/60 px-4">Real results from businesses we've helped automate.</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="text-4xl sm:text-5xl gradient-text mb-3 sm:mb-4 font-bold">15hrs</div>
              <h4 className="text-white mb-2 text-base sm:text-lg font-semibold">Saved Per Week</h4>
              <p className="text-white/60 text-sm sm:text-base">Marketing agency automated client onboarding and reporting</p>
            </div>
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="text-4xl sm:text-5xl gradient-text mb-3 sm:mb-4 font-bold">95%</div>
              <h4 className="text-white mb-2 text-base sm:text-lg font-semibold">Fewer Errors</h4>
              <p className="text-white/60 text-sm sm:text-base">E-commerce business eliminated manual order processing</p>
            </div>
            <div className="card-3d glass border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-white/20 transition-all">
              <div className="text-4xl sm:text-5xl gradient-text mb-3 sm:mb-4 font-bold">$50k</div>
              <h4 className="text-white mb-2 text-base sm:text-lg font-semibold">Annual Savings</h4>
      ...
      {/* CTA */}
      <section className="relative pt-16 sm:pt-20 lg:pt-24 pb-20 sm:pb-24 lg:pb-32 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden rounded-3xl sm:rounded-[3rem] glass border border-white/10 p-8 sm:p-12 lg:p-16">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-2xl mx-auto">
                <Link
                  to="/contact"
                  className="btn-3d bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base font-semibold"
                >
