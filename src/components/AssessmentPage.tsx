...
export function AssessmentPage() {
  ...
  const painPoints: PainPoint[] = [
    { text: 'Handle customer inquiries 24/7 without hiring more staff', categories: ['chatbots', 'voice-agents'] },
    { text: 'Automate repetitive data entry and form filling', categories: ['automation'] },
    { text: 'Qualify and route leads automatically', categories: ['automation', 'chatbots'] },
    { text: 'Answer common questions instantly on your website', categories: ['chatbots'] },
    { text: 'Schedule appointments without back-and-forth emails', categories: ['automation', 'chatbots'] },
    { text: 'Handle incoming calls when your team is busy', categories: ['voice-agents'] },
    { text: 'Send automated follow-ups and reminders', categories: ['automation'] },
    { text: 'Process orders and payments automatically', categories: ['automation'] },
    { text: 'Provide instant customer support during peak hours', categories: ['chatbots', 'voice-agents'] },
    { text: 'Connect your software tools so data flows automatically', categories: ['automation'] },
    { text: 'Screen and transfer calls based on caller needs', categories: ['voice-agents'] },
    { text: 'Reduce response time to customer inquiries', categories: ['chatbots', 'voice-agents'] },
    { text: 'Collect customer information before speaking to them', categories: ['chatbots', 'voice-agents'] },
    { text: 'Automate invoice generation and payment reminders', categories: ['automation'] },
    { text: 'Handle multiple customer conversations simultaneously', categories: ['chatbots'] },
    { text: 'Provide consistent answers to frequently asked questions', categories: ['chatbots', 'voice-agents'] },
    { text: 'Free up your team from repetitive administrative tasks', categories: ['automation'] },
    { text: 'Convert website visitors into leads automatically', categories: ['chatbots'] },
    { text: 'Manage bookings and cancellations without manual work', categories: ['automation', 'chatbots'] },
    { text: 'Take messages and capture caller information after hours', categories: ['voice-agents'] },
  ];
