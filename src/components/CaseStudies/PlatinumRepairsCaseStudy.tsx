...
export function PlatinumRepairsCaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#0f0f1e] pt-32">
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 text-center">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
          We Help Platinum Repairs Save <span className="gradient-text">Hundreds</span> of Hours Every Week
        </h1>
        <p className="text-lg lg:text-xl text-white/70 max-w-3xl mx-auto mb-8 leading-relaxed">
        ...
        <a href="#impact" className="text-indigo-400 font-medium text-lg hover:text-indigo-300 transition-colors">
          See the results ↓
        </a>
      </section>
      ...
      <section id="impact" className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-center text-white mb-6">The Tangible Impact</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="glass rounded-3xl p-8 border border-white/10">
              ...
              <p className="text-white/70 mb-6">Manager's Time Freed Up</p>
              <div className="h-48">
            ...
            <div className="glass rounded-3xl p-8 border border-white/10">
              ...
              <p className="text-white/70 mb-6">Reduction in Daily Inquiries</p>
              <div className="h-48">
            ...
            {/* AI Chats Card */}
            <div className="glass rounded-3xl p-8 border border-white/10 flex flex-col justify-center">
              <div className="flex items-center justify-center mb-4">
                <MessageSquare className="w-12 h-12 text-indigo-400" />
              </div>
              <span className="text-5xl font-bold text-indigo-400 mb-4 text-center">200+</span>
              <h3 className="text-2xl font-bold text-white mb-2 text-center">AI Chats Monthly</h3>
              <p className="text-white/70 text-center">Our chatbot successfully handles over 200 client chats every month, providing instant answers 24/7.</p>
            </div>
            ...
            <div className="glass rounded-3xl p-8 border border-white/10 flex flex-col justify-center">
              ...
              <span className="text-5xl font-bold text-green-400 mb-4 text-center">R12,000</span>
              <h3 className="text-2xl font-bold text-white mb-2 text-center">Saved Per Month</h3>
              <p className="text-white/70 text-center">By reducing manual tasks and streamlining support, we save Platinum Repairs an estimated R12,000 in monthly operational costs.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-center text-white mb-6">Our Solutions in Action</h2>
          <p className="text-lg text-white/70 text-center max-w-3xl mx-auto mb-12">
            ...
            <div className="p-8 lg:p-12">
              {activeTab === 'client-comms' && (
                <div className="space-y-8">
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">AI Chatbot & Voice Agents</h3>
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">Automatic Emails & Follow-ups</h3>
                    <p className="text-white/70 leading-relaxed">
              ...
              {activeTab === 'operations' && (
                <div className="space-y-8">
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">Insurance Claim Processing</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">Inventory & Parts Management</h3>
                    <p className="text-white/70 leading-relaxed">
              ...
              {activeTab === 'philosophy' && (
                <div className="space-y-8">
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">Thousands of Automations</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-3">Our 80/20 Approach</h3>
                    <p className="text-white/70 leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Born from Your Exact Challenges</h2>
            ...
            <div className="glass p-8 rounded-3xl border border-white/10">
              <h3 className="text-2xl font-bold text-white mb-6">With our help:</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-lg">Your clients will enjoy smoother, faster service.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-lg">Your team will have time to focus on what truly matters.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-lg">Your business will run smoothly and improve profitability.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass rounded-3xl p-12 lg:p-16 text-center border border-white/10">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Are you tired of these bottlenecks?</h2>
            <div className="max-w-md mx-auto text-left text-lg space-y-3 mb-10">
            ...
            <Link
              to="/contact"
              className="inline-block btn-3d bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xl px-10 py-4 rounded-full font-medium"
            >
              Book a Chat & Get 50% Off Your First 3 Months
            </Link>
            <p className="text-sm text-white/50 mt-4">(Mention this case study for your discount)</p>
          </div>
        </div>
      </section>
    </div>
