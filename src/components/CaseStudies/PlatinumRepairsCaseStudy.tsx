  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#0f0f1e] pt-32">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-12 sm:pb-16 lg:pb-20 text-center">
        ...
        <a href="#impact" className="text-indigo-400 font-medium text-2xl sm:text-3xl hover:text-indigo-300 transition-colors">
          See the results ↓
        </a>
      </section>
            ...
            <div className="p-6 sm:p-8 lg:p-12">
              ...
              {activeTab === 'operations' && (
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">Inventory & Parts Management</h3>
                    <p className="text-2xl sm:text-3xl text-white/70 leading-relaxed">
              ...
              {activeTab === 'philosophy' && (
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">Thousands of Automations</h3>
                    <p className="text-2xl sm:text-3xl text-white/70 leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">Our 80/20 Approach</h3>
                    <p className="text-2xl sm:text-3xl text-white/70 leading-relaxed">
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div>
              <h2 className="text-5xl sm:text-6xl lg:text-6xl font-bold gradient-text mb-4 sm:mb-6">Born from Your Exact Challenges</h2>
            ...
            <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/10">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-white/80 text-2xl sm:text-3xl">Your clients will enjoy smoother, faster service.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-2xl sm:text-3xl">Your team will have time to focus on what truly matters.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-2xl sm:text-3xl">Your business will run smoothly and improve profitability.</span>
                </li>
              </ul>
            </div>
          </div>
