  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1e] via-[#1a1a2e] to-[#0f0f1e] pt-32">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-12 sm:pb-16 lg:pb-20 text-center">
        ...
        <a href="#impact" className="text-green-400 font-medium text-base sm:text-lg hover:text-green-300 transition-colors">
      ...
      <section id="impact" className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="h-6 sm:h-10 mb-4 sm:mb-6"></div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold gradient-text mb-4 sm:mb-6">Project Delivery</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10">
              <h3 className="text-3xl sm:text-4xl font-bold text-white mb-2">15+</h3>
              <p className="text-sm sm:text-base text-white/70 mb-4 sm:mb-6">Major Features Built</p>
            ...
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10">
              ...
              <p className="text-sm sm:text-base text-white/70 mb-4 sm:mb-6">Integration Complete</p>
              <div className="h-40 sm:h-48">
            ...
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 flex flex-col justify-center">
              ...
              <span className="text-4xl sm:text-5xl font-bold text-green-400 mb-3 sm:mb-4 text-center">13+</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 text-center">Pages Developed</h3>
              <p className="text-sm sm:text-base text-white/70 text-center">From homepage to admin panel, fully responsive across all devices.</p>
            </div>
            ...
            <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 flex flex-col justify-center">
              ...
              <span className="text-4xl sm:text-5xl font-bold text-amber-400 mb-3 sm:mb-4 text-center">15,000</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 text-center">Monthly Automations</h3>
              <p className="text-sm sm:text-base text-white/70 text-center">Automated email communications and feedback via webhook integration.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <div className="glass p-6 sm:p-8 rounded-2xl border border-white/10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">Multi-Feature Platform</h3>
                </div>
              ...
              <div className="glass p-6 sm:p-8 rounded-2xl border border-white/10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">Subscription Management</h3>
                </div>
                <p className="text-white/70 leading-relaxed">
              ...
              <div className="glass p-6 sm:p-8 rounded-2xl border border-white/10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">Content Management</h3>
                </div>
                <p className="text-white/70 leading-relaxed">
              ...
              <div className="glass p-6 sm:p-8 rounded-2xl border border-white/10">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">Automation Integration</h3>
                </div>
                <p className="text-white/70 leading-relaxed">
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="h-6 sm:h-10 mb-4 sm:mb-6"></div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold gradient-text mb-4 sm:mb-6">The Solution: A Complete Digital Ecosystem</h2>
            <p className="text-base sm:text-lg text-white/70 max-w-3xl mx-auto mb-10 sm:mb-12">
            ...
            <div className="p-6 sm:p-8 lg:p-12">
              {activeTab === 'platform' && (
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Business Directory & Profiles</h3>
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Job Portal (Werksgeleenthede)</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Marketplace (Markplein) & Special Offers</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
              ...
              {activeTab === 'technical' && (
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Modern Technology Stack</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Secure Authentication & Payments</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Advanced Features & Optimization</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
              ...
              {activeTab === 'business' && (
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Subscription Revenue Model</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Targeted Community Focus</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Scalable Growth Strategy</h3>
                    <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4">
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold gradient-text mb-4 sm:mb-6">Full-Stack Development Excellence</h2>
            ...
            <div className="glass p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/10">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-white/80 text-base sm:text-lg">Launch complete digital platforms that serve your entire community</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-base sm:text-lg">Build scalable subscription-based revenue streams</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-base sm:text-lg">Integrate automation to reduce manual work and improve user experience</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />
                  <span className="text-white/80 text-base sm:text-lg">Get enterprise-grade technology at accessible pricing</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 border border-white/10">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 sm:mb-8">Ready to Build Your Digital Platform?</h2>
